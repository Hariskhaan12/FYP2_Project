...
class MembershipService
{
    ...
    {
        $membership = Membership::query()->orderBy('id','DESC');
    ...
    {
        $membership =UserMembershipPlan::with('users')->with('membership')->orderBy('id','DESC');
    ...
    public function update($currenSlug, $request)
    {
        ...
        try {
            $membership = Membership::where('slug', $currenSlug)->first();
