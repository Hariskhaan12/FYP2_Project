        ...
        return datatables($currencies)
            ...
            ->addColumn('action', function ($data) {
                ...
                <li class="align-items-center d-flex gap-2">
                    ...
                    <button onclick="deleteItem(\'' . route('admin.setting.languages.delete', $data->id) . '\', \'commonDataTable\')" class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-ededed bg-white" title="'.__('Delete').'">
