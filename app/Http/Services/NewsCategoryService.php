...
class NewsCategoryService
{
    ...
    {
        $newsCategory = NewsCategory::query()->orderBy('id','DESC');
    ...
    {
        return NewsCategory::join('news', 'news.news_category_id', 'news_categories.id')->where('news.status', STATUS_ACTIVE)->groupBy('news_categories.id')->groupBy('news_categories.name')->select('news_categories.name', 'news_categories.id')->get();
    }
