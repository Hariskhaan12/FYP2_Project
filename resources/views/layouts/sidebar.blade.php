...
<div class="zSidebar" data-background="{{ asset('assets/images/sidebar-bg.png') }}">
    ...
    <a href="{{ route('index') }}" class="d-block mx-26 mb-27 max-w-146 pt-23">
        <!-- <img class="max-h-40" src="{{ asset('frontend/images/sidebar_logo.png') }}" alt="{{ getOption('app_name') }}"/> -->
    </a>
    <!-- Menu & Logout -->
    <div class="zSidebar-fixed">
        <ul class="zSidebar-menu" id="sidebarMenu">
            ...
            <!-- <li>
                <a href="{{ route('membership-package') }}"
                   class="d-flex align-items-center cg-10 {{ $activeMembershipPack ?? '' }}">
                    ...
                    <span>{{ __('Course Material') }}</span>
                </a>
                
            </li> -->
            <!-- /////// -->
            <li>
                <a href="#myCourses" data-bs-toggle="collapse" role="button" aria-controls="myCourses"
                   class="d-flex align-items-center cg-10 {{ isset($showEvent) ? 'active' : 'collapsed' }}"
                   aria-expanded="{{ isset($showEvent) ? 'true' : 'false' }}">
                    <div class="d-flex">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="collapse {{ $showEvent ?? '' }}" id="myCourses" data-bs-parent="#sidebarMenu">
                    <ul class="zSidebar-submenu">
                        @if (auth()->user()->role == USER_ROLE_ADMIN)
                            <li><a class="{{ $activeEventCategory ?? '' }}"
                                   href="{{ route('admin.event.category.index') }}">{{ __('Course Category') }}</a>
                            </li>
                            <li><a class="{{ $activeEventPending ?? '' }}"
                                   href="{{ route('admin.event.pending.index') }}">{{ __('Pending Course') }}</a>
                            </li>
                        @endif
                        <li><a class="{{ $activeEventCreate ?? '' }}"
                               href="{{ route('event.create') }}">{{ __('Add Course') }}</a>
                        </li>
                        
                        <li><a class="{{ $activeTicket ?? '' }}"
                               href="{{ route('event.my-ticket') }}">{{ __('My Courses') }}</a>
                        </li>
                        <li><a class="{{ $activeAllEvent ?? '' }}"
                               href="{{ route('event.all') }}">{{ __('All Courses') }}</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            @if (auth()->user()->role == USER_ROLE_ADMIN)
                ...
                <!-- <li>
                    <span class="align-items-center cg-10 has-subMenu-arrow pl-13">
