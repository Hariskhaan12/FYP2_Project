        ...
        <div class="modal-content">
            <form class="ajax" action="{{ route('admin.setting.languages.import') }}" method="POST"
                ...
                <div class="modal-footer justify-content-start">
                    <button type="button" class="border-0 theme-btn-back me-3" data-bs-dismiss="modal" title="{{ __('Back') }}">{{
                        __('Back')
                        }}</button>
                    <button type="submit" class="theme-btn me-3" title="{{ __('Submit') }}">{{ __('Import') }}</button>
                </div>
            </form>
        </div>
    </div>
