                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 offset-md-1 offset-lg-0 col-md-5 col-sm-10">
                        <div class="pl-xl-75">
                            ...
                            <ul class="footer-nav">
                                <li><a href="{{ route('all.notice') }}"
                                        class="fs-18 fw-500 lh-28 text-white-80 hover-color-white">Notice</a></li>
                                ...
                                <li><a href="{{ route('all.event') }}"
                                        class="fs-18 fw-500 lh-28 text-white-80 hover-color-white">Events</a></li>
                                ...
                                <li><a href="{{ route('all.stories') }}"
                                        class="fs-18 fw-500 lh-28 text-white-80 hover-color-white">Stories</a>
                                ...
                                <li><a href="{{ route('all.news') }}"
                                        class="fs-18 fw-500 lh-28 text-white-80 hover-color-white">News</a>
                                </li>
