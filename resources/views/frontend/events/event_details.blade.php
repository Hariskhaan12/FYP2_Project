    ...
    <div class="container">
      ...
      <div class="max-w-548 m-auto text-center pb-45">
        <div class="d-flex justify-content-center align-items-center cg-63 pb-12">
          <p class="fs-18 fw-500 lh-28 text-para-color line-horizontal-event">{{ date('M d, Y', strtotime($event->created_at)) }}</p>
          <p class="fs-18 fw-500 lh-28 text-para-color">{{ date('h:i A', strtotime($event->created_at)) }}</p>
        </div>
